...
CC Switch は **[ccswitch.io](https://ccswitch.io)**、**[GitHub Releases](https://github.com/tanaer/cc-switch/releases)**、またはプロジェクトのソースリポジトリからのみ入手してください。支払い、チャージ、ログイン情報の入力を求める「CC Switch」サイトやクライアントは公式ではありません。
...
1. [Releases ページ](https://github.com/tanaer/cc-switch/releases) にアクセス
