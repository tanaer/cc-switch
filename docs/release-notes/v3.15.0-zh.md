...
> | 源码     | **[github.com/tanaer/cc-switch](https://github.com/tanaer/cc-switch)** |
> | 下载     | **[GitHub Releases](https://github.com/tanaer/cc-switch/releases)**        |
> | 作者     | **[@farion1231](https://github.com/farion1231)**                               |
> | 举报山寨 | **[GitHub Issues](https://github.com/tanaer/cc-switch/issues)**            |
>
...
新增 BytePlus、ClaudeCN、RunAPI、PatewayAI 服务商条目；交叉链接 BytePlus 与火山条目；刷新 CrazyRouter 的 $2 额度领取流程、Compshare 描述、Right Code 描述、其他服务商的 logo 与列表项；把 LionCC logo 抹平到白底；中文 README 的服务商 logo 切到火山图；在 README 副标题中加入 Hermes Agent。
