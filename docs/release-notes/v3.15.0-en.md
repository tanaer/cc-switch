...
> | Source             | **[github.com/tanaer/cc-switch](https://github.com/tanaer/cc-switch)** |
> | Downloads          | **[GitHub Releases](https://github.com/tanaer/cc-switch/releases)**        |
> | Author             | **[@farion1231](https://github.com/farion1231)**                               |
> | Report an Imposter | **[GitHub Issues](https://github.com/tanaer/cc-switch/issues)**            |
>
...
### README Provider Refresh (zh / en / ja)

Added BytePlus, ClaudeCN, RunAPI, and PatewayAI provider entries; cross-linked BytePlus and Volcengine entries; refreshed the CrazyRouter $2 credit claim flow, the Compshare blurb, the Right Code blurb, and other provider logos and listings; flattened the LionCC logo onto a white background; switched the Chinese README's provider logo to the Volcengine artwork; added Hermes Agent to the README subtitles.
...
Visit [Releases](https://github.com/tanaer/cc-switch/releases/latest) to download the appropriate version.
