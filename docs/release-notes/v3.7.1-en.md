...
Visit [Releases](https://github.com/tanaer/cc-switch/releases/latest) to download the latest version
...
Visit [Releases](https://github.com/tanaer/cc-switch/releases/latest) to download:
...
- **Issues**: [GitHub Issues](https://github.com/tanaer/cc-switch/issues)
- **Discussions**: [GitHub Discussions](https://github.com/tanaer/cc-switch/discussions)
