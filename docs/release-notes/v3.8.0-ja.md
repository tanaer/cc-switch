...
[Releases](https://github.com/tanaer/cc-switch/releases/latest) から入手:
...
**Zhipu AI** - GLM CODING PLAN プロバイダー  
...
**MiniMax** - MiniMax M2 CODING PLAN プロバイダー  
...
- **Issue**: [GitHub Issues](https://github.com/tanaer/cc-switch/issues)
