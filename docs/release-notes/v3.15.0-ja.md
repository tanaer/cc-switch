...
> | ソースコード | **[github.com/tanaer/cc-switch](https://github.com/tanaer/cc-switch)** |
> | ダウンロード | **[GitHub Releases](https://github.com/tanaer/cc-switch/releases)**        |
> | 作者         | **[@farion1231](https://github.com/farion1231)**                               |
> | 偽サイト通報 | **[GitHub Issues](https://github.com/tanaer/cc-switch/issues)**            |
>
...
### README プロバイダー更新（中 / 英 / 日）

BytePlus、ClaudeCN、RunAPI、PatewayAI のプロバイダーエントリを追加; BytePlus と Volcengine のエントリを相互リンク; CrazyRouter の $2 クレジット受領フロー、Compshare の説明、Right Code の説明、その他プロバイダーのロゴおよびリストアイテムをリフレッシュ; LionCC のロゴを白背景にフラット化; 中国語 README のプロバイダーロゴを Volcengine 画像に切り替え; README のサブタイトルに Hermes Agent を追加。
...
[Releases](https://github.com/tanaer/cc-switch/releases/latest) から対応バージョンをダウンロードしてください。
