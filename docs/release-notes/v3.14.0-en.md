...
### README Provider Updates

- Updated SiliconFlow signup bonus to ¥16
- Trimmed the SSSAiCode provider blurb
- Updated partner logos
- Added LemonData as a new provider
...
- Updated the PIPELLM provider website URL to `code.pipellm.ai`
