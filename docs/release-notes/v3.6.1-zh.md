...
- [中文文档](https://github.com/tanaer/cc-switch/blob/main/README_ZH.md)
- [English Documentation](https://github.com/tanaer/cc-switch/blob/main/README.md)
- [完整更新日志](https://github.com/tanaer/cc-switch/blob/main/CHANGELOG.md)
...
特别感谢：
- **智谱 AI** - 通过 GLM CODING PLAN 支持本项目
- **PackyCode** - 新加入的官方合作伙伴
- **ZyphrZero** - 贡献托盘菜单同步修复 (#179)

---

**完整变更记录**: https://github.com/tanaer/cc-switch/compare/v3.6.0...v3.6.1
...
**项目地址**: https://github.com/tanaer/cc-switch
