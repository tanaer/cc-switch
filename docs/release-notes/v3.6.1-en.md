...
**[中文更新说明 Chinese Documentation →](https://github.com/tanaer/cc-switch/blob/main/docs/release-notes/v3.6.1-zh.md)**
...
- [中文文档 (Chinese)](https://github.com/tanaer/cc-switch/blob/main/README_ZH.md)
- [English Documentation](https://github.com/tanaer/cc-switch/blob/main/README.md)
- [完整更新日志 (Full Changelog)](https://github.com/tanaer/cc-switch/blob/main/CHANGELOG.md)
...
Special thanks to:
- **Zhipu AI** - For supporting this project with GLM CODING PLAN
- **PackyCode** - New official partner
- **ZyphrZero** - For contributing tray menu sync fix (#179)

---

**Full Changelog**: https://github.com/tanaer/cc-switch/compare/v3.6.0...v3.6.1
...
- Provider banner integration in README
...
**Project Repository**: https://github.com/tanaer/cc-switch
