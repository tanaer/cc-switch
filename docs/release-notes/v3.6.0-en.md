...
**[中文更新说明 Chinese Documentation →](https://github.com/tanaer/cc-switch/blob/main/docs/release-notes/v3.6.0-zh.md)**
...
Special thanks to **Zhipu AI** for supporting this project with their GLM CODING PLAN!

---

**Full Changelog**: https://github.com/tanaer/cc-switch/compare/v3.5.1...v3.6.0
